...
// /*   Updated: 2025/06/27 16:50:24 by mlitvino         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// // 				sprite_array[i]->move_spd,
// 					sprite_array[i]->turn_spd);
...
// 			* BLOCK_SIZE / 2, list->grid_y * BLOCK_SIZE / 2);
// 	}
// 	ft_printf("----DOOR_END----\n");
// }
...
// 			// {
// 			// 	ft_printf("%s%d %s", GREEN,
// 					data->unit_map[j][i], RESET);
// 			// }
...
// 			// {
// 			// 	ft_printf("%s%d %s", BLUE, data->unit_map[j][i],
// 					RESET);
// 			// }
// 		}
// 		ft_printf("}\n");
...
// 		mlx_put_pixel(data->mlx_data.scr_img,
// 			data->plane.center.x, y, 0xFF0000FF);
// }
...
// 		// right_ver line
// 		for (uint32_t y = 0; y < menu->height; y++)
// 			mlx_put_pixel(menu, main_but.x + BUTTON_DX, y,
// 				0xFF0000FF);
// 		// 1_but_hor_1 line
...
// 		// 1_but_hor_2 line
// 		for (uint32_t x = 0; x < menu->width; x++)
// 			mlx_put_pixel(menu, x, main_but.y + BUTTON_DY,
// 				0xFF0000FF);
// 		// 2_but_hor_1 line
// 		for (uint32_t x = 0; x < menu->width; x++)
// 			mlx_put_pixel(menu, x, main_but.y + BUTTON_DY
// 				+ BUTTON_DY2, 0xFF0000FF);
// 		// 2_but_hor_2 line
// 		for (uint32_t x = 0; x < menu->width; x++)
// 			mlx_put_pixel(menu, x, main_but.y + BUTTON_DY * 2
// 				+ BUTTON_DY2, 0xFF0000FF);
// 		// 3_but_hor_1 line
// 		for (uint32_t x = 0; x < menu->width; x++)
// 			mlx_put_pixel(menu, x, main_but.y + (BUTTON_DY
// 					+ BUTTON_DY2) * 2, 0xFF0000FF);
// 		// 3_but_hor_2 line
// 		for (uint32_t x = 0; x < menu->width; x++)
// 			mlx_put_pixel(menu, x, main_but.y + (BUTTON_DY
// 					+ BUTTON_DY2) * 2 + BUTTON_DY, 0xFF0000FF);
// 	}
// 	// pause
// 	else if (state == PAUSE || state == WIN || state == DEATH)
// 	{
// 		pause = data->mlx_data.textrs_img[state];
// 		// left_ver line
// 		for (uint32_t y = 0; y < pause->height; y++)
// 			mlx_put_pixel(pause, pause_but.x, y, 0xFF0000FF);
// 		// right_ver line
// 		for (uint32_t y = 0; y < pause->height; y++)
// 			mlx_put_pixel(pause, pause_but.x + BUTTON_DX, y,
// 				0xFF0000FF);
// 		// 1_but_hor_1 line
...
// 		// 1_but_hor_2 line
// 		for (uint32_t x = 0; x < pause->width; x++)
// 			mlx_put_pixel(pause, x, pause_but.y + BUTTON_DY,
// 				0xFF0000FF);
// 		// 2_but_hor_1 line
// 		for (uint32_t x = 0; x < pause->width; x++)
// 			mlx_put_pixel(pause, x, pause_but.y + BUTTON_DY
...
// 		// 2_but_hor_2 line
// 		for (uint32_t x = 0; x < pause->width; x++)
// 			mlx_put_pixel(pause, x, pause_but.y + BUTTON_DY * 2
// 				+ BUTTON_DY2, 0xFF0000FF);
// 		// 3_but_hor_1 line
// 		for (uint32_t x = 0; x < pause->width; x++)
// 			mlx_put_pixel(pause, x, pause_but.y + (BUTTON_DY
